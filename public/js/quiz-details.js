        ...
        html += `<div class="col-md-8 mt-3">
                            <div class="card">
                                <div class="card-body" id="headingOne" style="height: 6.375rem;">
                                    <button class="btn btn-question" type="button" data-toggle="collapse" data-parent="#accordionQuizzes" data-target="#collapse${index +
                                      1}"
                                        aria-expanded="true" aria-controls="collapseOne">
                                        <span class="ellipsis text-left">Q${index +
                                          1}. <span
                                ...
                                <div id="collapse${index +
                                  1}" class="collapse" aria-labelledby="headingOne" >
  ...
  $("#collapseToggle").click(e => {
    ...
    if (
      document
        ...
        .textContent.includes("HIDE ANSWERS")
    ) {
