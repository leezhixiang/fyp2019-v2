window.onload = () => {
  ...
  getClasses = () => {
    fetch(`/api/classes/`, {
      ...
      .then(classes => {
        ...
        const memberClasses = classes.filter(
        ...
        if (adminClasses.length !== 0) {
          ...
          adminClasses.forEach(myClass => {
            checkExist = () => {
              if (
                myClass.section !== undefined ||
                myClass.tutorial_group !== undefined
              ) {
                                      ...
                                      myClass._id
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div class="body hover-body mb-3 flex-grow-1">
                                                <div class="class-name ellipsis1" style="font-size:1.25rem">${
                                                  myClass.name
                                                }</div>
        ...
        if (memberClasses.length !== 0) {
          ...
          memberClasses.forEach(myClass => {
            ...
            html += `<div class="col-md-4 class-card__wrap class-card__wrap--${checkAdmin(
              myClass
            )} mb-3">
                                <div class="class-card p-3" style="height:126px">
                                    <a href="/classes/${
  ...
  document
    .querySelector("#createClassBtn")
    .addEventListener("click", function(e) {
      $("#createClassModal").modal("show");
    });

  document
    .querySelector("#joinClassBtn")
    .addEventListener("click", function(e) {
