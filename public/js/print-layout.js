window.onload = () => {
    ...
    $("#fontSizeInput").bind('keyup mouseup', () => {
        ...
        document.querySelector('.content-body').style.fontSize = `${checkedValue}px`;
    });

    document.querySelector('#shuffleQuestionsCheckbox').addEventListener('click', () => {
        const checkedValue = document.querySelector('#shuffleQuestionsCheckbox').checked;

        questions = shuffle(questions);
        displayQuestions(questions);
    })

    document.querySelector('#shuffleAnswersCheckbox').addEventListener('click', () => {
        const checkedValue = document.querySelector('#shuffleAnswersCheckbox').checked
    ...
    document.querySelector('#checkBoxesCheckbox').addEventListener('click', () => {
        const checkedValue = document.querySelector('#checkBoxesCheckbox').checked;
    ...
    document.querySelector('#showAnsOptsCheckbox').addEventListener('click', () => {
        const checkedValue = document.querySelector('#showAnsOptsCheckbox').checked
    ...
    fetch(`http://localhost:3000/api/quizzes/${quizId}`)
        ...
        .then(res => {
            ...
            document.querySelector('#totalQuestion').textContent = `${quiz.questions.length} Questions`;
