window.onload = () => {
    ...
    fetch(`http://localhost:3000/api/reports/hoster/${hoster_reportId}`, {
        ...
        .then((report) => {
            ...
            document.querySelector('#reportTimeStamp').textContent = hosterReport.hosted_date;
            ...
            document.querySelector('#gameAccuracy').textContent = `${hosterReport.accuracy}%`;
            document.querySelector('#totalQuestions').textContent = hosterReport.questions.length;
            document.querySelector('#totalPlayers').textContent = hosterReport.player_results.length;
